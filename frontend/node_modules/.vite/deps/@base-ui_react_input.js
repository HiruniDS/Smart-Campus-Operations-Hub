...
function useRegisterFieldControl(controlRef, params) {
  ...
  const sourceRef = React14.useRef(null);
...
// node_modules/@base-ui/react/esm/field/control/FieldControl.js
var FieldControl = React15.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React16.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React16.useMemo(() => {
    return {
...
var FieldItemContext = React17.createContext({
  disabled: false
});
...
var CheckboxGroupContext = React18.createContext(void 0);
if (true) CheckboxGroupContext.displayName = "CheckboxGroupContext";
function useCheckboxGroupContext(optional = true) {
  const context = React18.useContext(CheckboxGroupContext);
...
var FieldItem = React19.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const fieldItemContext = React19.useMemo(() => ({
    disabled
  }), [disabled]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
