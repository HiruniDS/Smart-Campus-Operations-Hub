...
import "./chunk-DW4JOQKA.js";
import {
  useRefWithInit,
  useRenderElement
} from "./chunk-ZEDBCJRI.js";
import "./chunk-72NKH3IZ.js";
import {
  require_react
...
function useDialogRoot(params) {
  ...
  const handleImperativeClose = React8.useCallback(() => {
  ...
  const [ownNestedOpenDialogs, setOwnNestedOpenDialogs] = React8.useState(0);
  const [ownNestedOpenDrawers, setOwnNestedOpenDrawers] = React8.useState(0);
  ...
  const activeTriggerProps = React8.useMemo(() => getReferenceProps(triggerProps), [getReferenceProps, triggerProps]);
  const inactiveTriggerProps = React8.useMemo(() => getTriggerProps(triggerProps), [getTriggerProps, triggerProps]);
  const popupProps = React8.useMemo(() => getFloatingProps(), [getFloatingProps]);
...
var DialogStore = class _DialogStore extends ReactStore {
  constructor(initialState) {
    super(createInitialState(initialState), {
      popupRef: React9.createRef(),
      backdropRef: React9.createRef(),
      internalBackdropRef: React9.createRef(),
...
var IsDrawerContext = React10.createContext(false);
...
function DialogRoot(props) {
  ...
  const isDrawer = React10.useContext(IsDrawerContext);
  ...
  return (0, import_jsx_runtime3.jsx)(IsDrawerContext.Provider, {
    value: false,
    children: (0, import_jsx_runtime3.jsx)(DialogRootContext.Provider, {
      value: contextValue,
...
var DialogViewport = React11.forwardRef(function DialogViewport2(componentProps, forwardedRef) {
  const {
    className,
    render,
    children,
...
var DialogTitle = React12.forwardRef(function DialogTitle2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DialogTrigger = React13.forwardRef(function DialogTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    disabled = false,
  ...
  const triggerElementRef = React13.useRef(null);
  const {
    registerTrigger,
