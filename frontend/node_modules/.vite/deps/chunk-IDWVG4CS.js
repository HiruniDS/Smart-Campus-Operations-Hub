...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React30 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef20 = React30.useRef, useEffect9 = React30.useEffect, useMemo17 = React30.useMemo, useDebugValue2 = React30.useDebugValue;
...
function useFloatingPortalNode(props = {}) {
  ...
  const [containerElement, setContainerElement] = React2.useState(null);
...
var FloatingPortal = React2.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  const focusInsideDisabledRef = React2.useRef(false);
  ...
  const portalContextValue = React2.useMemo(() => ({
    beforeOutsideRef,
    afterOutsideRef,
    beforeInsideRef,
    afterInsideRef,
  ...
  return (0, import_jsx_runtime2.jsxs)(React2.Fragment, {
    children: [portalSubtree, (0, import_jsx_runtime2.jsxs)(PortalContext.Provider, {
      ...
      }), portalNode && ReactDOM.createPortal(children, portalNode), shouldRenderGuards && portalNode && (0, import_jsx_runtime2.jsx)(FocusGuard, {
        "data-type": "outside",
        ref: afterOutsideRef,
        onFocus: (event) => {
          var _a;
...
var useFloatingParentNodeId = () => {
  var _a;
  return ((_a = React3.useContext(FloatingNodeContext)) == null ? void 0 : _a.id) || null;
};
var useFloatingTree = (externalTree) => {
  const contextTree = React3.useContext(FloatingTreeContext);
...
function FloatingNode(props) {
  ...
  const parentId = useFloatingParentNodeId();
  return (0, import_jsx_runtime3.jsx)(FloatingNodeContext.Provider, {
...
function FloatingTree(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(FloatingTreeContext.Provider, {
    value: tree,
    children
  });
}
...
function FloatingFocusManager(props) {
  ...
  const orderRef = React4.useRef(["content"]);
  ...
  const pointerDownOutsideRef = React4.useRef(false);
  const lastFocusedTabbableRef = React4.useRef(null);
  const closeTypeRef = React4.useRef("");
  const lastInteractionTypeRef = React4.useRef("");
  ...
  return (0, import_jsx_runtime4.jsxs)(React4.Fragment, {
    children: [shouldRenderGuards && (0, import_jsx_runtime4.jsx)(FocusGuard, {
      "data-type": "inside",
...
function useClick(context, props = {}) {
  ...
  const pointerTypeRef = React5.useRef(void 0);
...
function useDismiss(context, props = {}) {
  ...
  const pressStartedInsideRef = React6.useRef(false);
  const pressStartPreventedRef = React6.useRef(false);
  const suppressNextOutsideClickRef = React6.useRef(false);
  const {
    escapeKey: escapeKeyBubbles,
    outsidePress: outsidePressBubbles
  } = normalizeProp(bubbles);
  const touchStateRef = React6.useRef(null);
  ...
  const currentPointerTypeRef = React6.useRef("");
  ...
  React6.useEffect(clearInsideReactTree, [outsidePress, clearInsideReactTree]);
...
function fastComponentRef(fn) {
  return React7.forwardRef(fastComponent(fn));
}
...
function useTriggerRegistration(id, store) {
  const registeredElementIdRef = React8.useRef(null);
  const registeredElementRef = React8.useRef(null);
  return React8.useCallback((element) => {
    if (id === void 0) {
      return;
    }
...
// node_modules/@base-ui/utils/esm/store/createSelectorMemoized.js
...
function useFocus(context, props = {}) {
  ...
  const blockedReferenceRef = React13.useRef(null);
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const closeWithDelay = React14.useCallback((event) => {
  ...
  useIsoLayoutEffect(() => {
    ...
    if (open && ((_a = instance.handleCloseOptions) == null ? void 0 : _a.blockPointerEvents) && isHoverOpen() && isElement(domReferenceElement) && floatingElement) {
      ...
      const scopeElement = ((_e = (_d = instance.handleCloseOptions) == null ? void 0 : _d.getScope) == null ? void 0 : _e.call(_d)) ?? instance.pointerEventsScopeElement ?? parentFloating ?? ref.closest("[data-rootownerid]") ?? doc.body;
  ...
  React14.useEffect(() => {
    ...
    function onFloatingMouseLeave(event) {
      ...
      const currentNodeId = ((_a = dataRef.current.floatingContext) == null ? void 0 : _a.nodeId) ?? nodeIdProp;
      const relatedTarget = event.relatedTarget;
      const isMovingIntoDescendantFloating = tree && currentNodeId && isElement(relatedTarget) && getNodeChildren(tree.nodesRef.current, currentNodeId, false).some((node) => {
        var _a2;
        return contains((_a2 = node.context) == null ? void 0 : _a2.elements.floating, relatedTarget);
      });
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const tree = useFloatingTree(externalTree);
  const instance = useHoverInteractionSharedState(store);
  const isHoverCloseActiveRef = React15.useRef(false);
  ...
  React15.useEffect(() => cleanupMouseMoveHandler, [cleanupMouseMoveHandler]);
  React15.useEffect(() => {
    if (!enabled) {
      return void 0;
    }
  ...
  React15.useEffect(() => {
    ...
    function onMouseEnter(event) {
      ...
      const isInClosingTransition = ((_a2 = isClosingRef.current) == null ? void 0 : _a2.call(isClosingRef)) ?? store.select("transitionStatus") === "ending";
    ...
    function onMouseLeave(event) {
      ...
      instance.restTimeout.clear();
      instance.restTimeoutPending = false;
      const handleCloseContextBase = dataRef.current.floatingContext ?? (getHandleCloseContext == null ? void 0 : getHandleCloseContext());
  ...
  return React15.useMemo(() => {
    ...
    return {
      ...
      onMouseMove(event) {
        ...
        if (currentOpen && isOverInactive && ((_a2 = instance.handleCloseOptions) == null ? void 0 : _a2.blockPointerEvents)) {
          const floatingElement = store.select("floatingElement");
          if (floatingElement) {
            const scopeElement = ((_c = (_b = instance.handleCloseOptions) == null ? void 0 : _b.getScope) == null ? void 0 : _c.call(_b)) ?? trigger.ownerDocument.body;
            applySafePolygonPointerEventsMutation(instance, {
              scopeElement,
...
function useInteractions(propsList = []) {
  ...
  const getReferenceProps = React16.useCallback(
    (userProps) => mergeProps(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    referenceDeps
  );
  const getFloatingProps = React16.useCallback(
    (userProps) => mergeProps(userProps, propsList, "floating"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    floatingDeps
  );
  const getItemProps = React16.useCallback(
    (userProps) => mergeProps(userProps, propsList, "item"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    itemDeps
  );
  const getTriggerProps = React16.useCallback(
...
function useListNavigation(context, props) {
  ...
  const focusItemOnOpenRef = React17.useRef(focusItemOnOpen);
  const indexRef = React17.useRef(selectedIndex ?? -1);
  const keyRef = React17.useRef(null);
  const isPointerModalityRef = React17.useRef(true);
  const onNavigate = useStableCallback((event) => {
    onNavigateProp(indexRef.current === -1 ? null : indexRef.current, event);
  });
  const previousOnNavigateRef = React17.useRef(onNavigate);
  const previousMountedRef = React17.useRef(!!floatingElement);
  const previousOpenRef = React17.useRef(open);
  const forceSyncFocusRef = React17.useRef(false);
  const forceScrollIntoViewRef = React17.useRef(false);
  const cancelQueuedFocusRef = React17.useRef(null);
  ...
  const item = React17.useMemo(() => {
    const itemProps = {
      ...
      onPointerLeave(event) {
        ...
        (_a = cancelQueuedFocusRef.current) == null ? void 0 : _a.call(cancelQueuedFocusRef);
  ...
  const getParentOrientation = React17.useCallback(() => {
    var _a, _b, _c;
  ...
  const ariaActiveDescendantProp = React17.useMemo(() => {
...
function useRole(context, props = {}) {
  ...
  const item = React18.useCallback(({
    active,
    selected
  }) => {
    const commonProps = {
...
function useTypeahead(context, props) {
  ...
  const prevIndexRef = React19.useRef(selectedIndex ?? activeIndex ?? -1);
...
var FloatingDelayGroupContext = React20.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
var InternalBackdrop = React25.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IDWVG4CS.js.map
