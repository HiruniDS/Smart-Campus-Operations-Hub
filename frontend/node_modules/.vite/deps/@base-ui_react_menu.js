...
import {
  ...
  useBaseUiId,
  useId
} from "./chunk-S6PUQVVU.js";
import {
  useButton,
  useCompositeRootContext
} from "./chunk-GZTKZYJR.js";
import {
  SafeReact,
  getComputedStyle,
  getParentNode,
...
import {
  ...
  useRenderElement,
  warn
} from "./chunk-ZEDBCJRI.js";
import {
  mergeProps
} from "./chunk-72NKH3IZ.js";
import {
  require_react
...
var CompositeListContext = React9.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function useCompositeListContext() {
  return React9.useContext(CompositeListContext);
}
...
function useCompositeListItem(params = {}) {
  ...
  const indexRef = React10.useRef(-1);
  const [index, setIndex] = React10.useState(externalIndex ?? (indexGuessBehavior === IndexGuessBehavior.GuessFromOrder ? () => {
...
var MenuCheckboxItem = React11.forwardRef(function MenuCheckboxItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  const {
    ...
    store,
    nativeButton,
    nodeId: menuPositionerContext == null ? void 0 : menuPositionerContext.context.nodeId,
...
var MenuCheckboxItemIndicator = React12.forwardRef(function MenuCheckboxItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const indicatorRef = React12.useRef(null);
  const {
    transitionStatus,
    setMounted
...
var MenuGroupContext = React13.createContext(void 0);
if (true) MenuGroupContext.displayName = "MenuGroupContext";
function useMenuGroupRootContext() {
  const context = React13.useContext(MenuGroupContext);
  if (context === void 0) {
...
var MenuGroup = React14.forwardRef(function MenuGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const [labelId, setLabelId] = React14.useState(void 0);
...
var MenuGroupLabel = React15.forwardRef(function MenuGroupLabelComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
...
var MenuItem = React16.forwardRef(function MenuItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuLinkItem = React17.forwardRef(function MenuLinkItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  const menuPositionerContext = useMenuPositionerContext(true);
  const nodeId = menuPositionerContext == null ? void 0 : menuPositionerContext.context.nodeId;
  const id = useBaseUiId(idProp);
  const {
    store
  } = useMenuRootContext();
...
var ToolbarRootContext = React18.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React18.useContext(ToolbarRootContext);
  if (context === void 0 && !optional) {
...
var MenuPopup = React19.forwardRef(function MenuPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const setPopupElement = React19.useCallback((element2) => {
...
var MenuPortalContext = React20.createContext(void 0);
if (true) MenuPortalContext.displayName = "MenuPortalContext";
function useMenuPortalContext() {
  const value = React20.useContext(MenuPortalContext);
  if (value === void 0) {
...
var MenuPortal = React21.forwardRef(function MenuPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
var DirectionContext = React22.createContext(void 0);
if (true) DirectionContext.displayName = "DirectionContext";
function useDirection() {
  const context = React22.useContext(DirectionContext);
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React23.useState(null);
  ...
  const arrowRef = React23.useRef(null);
  ...
  const autoUpdateOptions = React23.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React23.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React23.useMemo(() => {
    var _a2, _b2;
    return {
      position: "absolute",
...
function CompositeList(props) {
  ...
  const nextIndexRef = React24.useRef(0);
  const listeners = useRefWithInit(createListeners).current;
  const map = useRefWithInit(createMap).current;
  const [mapTick, setMapTick] = React24.useState(0);
  const lastTickRef = React24.useRef(mapTick);
  ...
  const sortedMap = React24.useMemo(() => {
  ...
  return (0, import_jsx_runtime5.jsx)(CompositeListContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React25.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuPositioner = React26.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  var _a;
  const {
    anchor: anchorProp,
  ...
  const previousTriggerRef = React26.useRef(null);
  ...
  if (parent.type === "context-menu") {
    anchor = anchorProp ?? ((_a = parent.context) == null ? void 0 : _a.anchor);
    align = align ?? "start";
...
var MenuRadioGroupContext = React27.createContext(void 0);
if (true) MenuRadioGroupContext.displayName = "MenuRadioGroupContext";
function useMenuRadioGroupContext() {
  const context = React27.useContext(MenuRadioGroupContext);
  if (context === void 0) {
...
var MenuRadioGroup = React28.memo(React28.forwardRef(function MenuRadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    value: valueProp,
...
var MenuRadioItemContext = React29.createContext(void 0);
if (true) MenuRadioItemContext.displayName = "MenuRadioItemContext";
function useMenuRadioItemContext() {
  const context = React29.useContext(MenuRadioItemContext);
  if (context === void 0) {
...
var MenuRadioItem = React30.forwardRef(function MenuRadioItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuRadioItemIndicator = React31.forwardRef(function MenuRadioItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const indicatorRef = React31.useRef(null);
  const {
    transitionStatus,
    setMounted
  } = useTransitionStatus(item.checked);
...
var MenubarContext = React32.createContext(null);
if (true) MenubarContext.displayName = "MenubarContext";
function useMenubarContext(optional) {
  const context = React32.useContext(MenubarContext);
...
var MenuStore = class _MenuStore extends ReactStore {
  constructor(initialState) {
    super({
      ...
      positionerRef: React33.createRef(),
      popupRef: React33.createRef(),
      typingRef: {
        current: false
      },
      itemDomElements: {
      ...
      triggerFocusTargetRef: React33.createRef(),
      beforeContentFocusGuardRef: React33.createRef(),
...
var MenuSubmenuRootContext = React34.createContext(void 0);
if (true) MenuSubmenuRootContext.displayName = "MenuSubmenuRootContext";
function useMenuSubmenuRootContext() {
  return React34.useContext(MenuSubmenuRootContext);
}
...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  const parentFromContext = React35.useMemo(() => {
  ...
  const floatingParentNodeId = store.useState("floatingParentNodeId");
  const openEventRef = React35.useRef(null);
  ...
  const allowOutsidePressDismissalRef = React35.useRef(parent.type !== "context-menu");
  ...
  const allowTouchToCloseRef = React35.useRef(true);
  ...
  const setOpen = useStableCallback((nextOpen, eventDetails) => {
    ...
    const newTriggerId = ((_a = eventDetails.trigger) == null ? void 0 : _a.id) ?? null;
  ...
  const handleImperativeClose = React35.useCallback(() => {
    store.setOpen(false, createChangeEventDetails(reason_parts_exports.imperativeAction));
  }, [store]);
  React35.useImperativeHandle(actionsRef, () => ({
  ...
  React35.useImperativeHandle(ctx == null ? void 0 : ctx.positionerRef, () => positionerElement, [positionerElement]);
  React35.useImperativeHandle(ctx == null ? void 0 : ctx.actionsRef, () => ({
    setOpen
  }), [setOpen]);
  ...
  const direction = useDirection();
  const setActiveIndex = React35.useCallback((index) => {
  ...
  const onTypingChange = React35.useCallback((nextTyping) => {
  ...
  const activeTriggerProps = React35.useMemo(() => {
  ...
  const inactiveTriggerProps = React35.useMemo(() => {
  ...
  const popupProps = React35.useMemo(() => getFloatingProps({
    onMouseMove() {
      store.set("allowMouseEnter", true);
      if (parent.type === "menu") {
        store.set("hoverEnabled", false);
  ...
  const itemProps = React35.useMemo(() => getItemProps(), [getItemProps]);
  store.useSyncedValues({
    floatingRootContext,
    activeTriggerProps,
...
function useCompositeItem(params = {}) {
  ...
  const compositeProps = React37.useMemo(() => ({
...
function useTriggerFocusGuards(store, triggerElementRef) {
  const preFocusGuardRef = React38.useRef(null);
  ...
  const handleFocusTargetFocus = useStableCallback((event) => {
    ...
    if (positionerElement && isOutsideEvent(event, positionerElement)) {
      (_a = store.context.beforeContentFocusGuardRef.current) == null ? void 0 : _a.focus();
    } else {
      ReactDOM.flushSync(() => {
        store.setOpen(false, createChangeEventDetails(reason_parts_exports.focusOut, event.nativeEvent, event.currentTarget));
      });
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React39.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const store = (handle == null ? void 0 : handle.store) ?? (rootContext == null ? void 0 : rootContext.store);
  if (!store) {
  ...
  const floatingTreeRoot = React40.useMemo(() => {
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime11.jsxs)(React40.Fragment, {
      children: [(0, import_jsx_runtime11.jsx)(FocusGuard, {
        ref: preFocusGuardRef,
        onFocus: handlePreFocusGuardFocus
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime11.jsx)(React40.Fragment, {
        children: element
      }, thisTriggerId), (0, import_jsx_runtime11.jsx)(FocusGuard, {
        ref: store.context.triggerFocusTargetRef,
        onFocus: handleFocusTargetFocus
      }, `${thisTriggerId}-post-focus-guard`)]
    });
  }
  return (0, import_jsx_runtime11.jsx)(React40.Fragment, {
    children: element
  }, thisTriggerId);
});
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React40.useState(false);
  useIsoLayoutEffect(() => {
...
function usePopupAutoResize(parameters) {
  ...
  const liveDimensionsRef = React42.useRef(null);
...
var DirectionProvider = function DirectionProvider2(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(DirectionContext.Provider, {
    value: contextValue,
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    childrenToRender = (0, import_jsx_runtime13.jsx)("div", {
      "data-current": true,
      ref: currentContainerRef,
      children
    }, currentContentKey);
  } else {
    childrenToRender = (0, import_jsx_runtime13.jsxs)(React44.Fragment, {
      ...
      }, "previous"), (0, import_jsx_runtime13.jsx)("div", {
        "data-current": true,
        ref: currentContainerRef,
...
var MenuViewport = React45.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var Separator = React46.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
...
// node_modules/@base-ui/react/esm/menu/submenu-trigger/MenuSubmenuTrigger.js
var MenuSubmenuTrigger = React47.forwardRef(function SubmenuTriggerComponent(componentProps, forwardedRef) {
  const {
    render,
    className,
    label,
  ...
  const registerTrigger = React47.useCallback((element2) => {
  ...
  const triggerElementRef = React47.useRef(null);
  const handleTriggerElementRef = React47.useCallback((el) => {
